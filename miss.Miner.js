...
MissionMiner.prototype.initMiss = function () { // Initialize / build objects required
  this.distanceToSpawn = this.findDistanceToSpawn(source);
...
MissionMiner.prototype.placeMinerContainer = function () {
  ...
  let ret = PathFinder.searchCustom(this.minerSource.pos, startingObject.pos, 1) //? might need to switch ends?
